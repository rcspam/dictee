...
#
# For NVIDIA CUDA acceleration, use the sibling PKGBUILD-cuda which
# bundles libonnxruntime.so + the CUDA providers and pip-installs the
# nvidia-*-cu12 wheels at post_install. The two packages declare each
